...
function ComputerPage(props) {
    ...
    const requestComputerList = async() => {
        try {
            const response = await axios.get("http://localhost:8080/api/v1/computers", {params}); //params 객체안에 company: "", cpu: ""가 들어가서 string query가 만들어진다. 
    ...
    return (
        ...
        >
                ...
                `}>
                    <h2>컴퓨터 수정 정보</h2>
                    <input type="text" name='computerId' placeholder='' onChange={handleUpdateInputChange} value={updateComputer.computerId} disabled={true} />
